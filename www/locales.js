...
/*
  ...
  ar:
  	displayAppName: "localized application name"
		title: "Window title"
...
AppRateLocales = {
  ar: {
    ...
    buttonLabels: ["لا، شكرا", "قيم البرنامج الآن", "ذكرني لاحقا"]
  },
  bn: {
    title: "রেট %@",
  ...
  ca: {
    ...
    buttonLabels: ["No, gràcies", "Recorda-m'ho més tard", "Escriure una ressenya ara"]
  },
  cs: {
    title: "Ohodnotit %@",
    message: "Pokud se vám líbí %@, našli byste si chvilku na ohodnocení aplikace? Nebude to trvat víc než minutu.\nDěkujeme za vaši podporu!",
    buttonLabels: ["Ne, děkuji", "Ohodnotit nyní", "Připomenout později"]
  },
  da: {
    title: "Vurdér %@",
    ...
    buttonLabels: ["Nej tak", "Vurdér nu", "Påmind mig senere"]
  },
  de: {
    title: "Bewerte %@",
    ...
    buttonLabels: ["Nein, danke", "Später erinnern", "Jetzt bewerten"]
  },
  el: {
    title: "Αξιολόγησε %@",
    ...
    buttonLabels: ["Όχι, ευχαριστώ", "Αξιολόγησε τώρα", "Υπενθύμιση αργότερα"]
  },
  en: {
    title: "Rate %@",
  ...
  es: {
    ...
    buttonLabels: ["No, gracias", "Recordarme más tarde", "Escribir reseña ahora"]
  },
  fa: {
    title: "نرخ %@",
    ...
    buttonLabels: ["نه، با تشکر", "آن را دوست ندارم حالا", "یادآوری من بعد"]
  },
  fr: {
    title: "Notez %@",
  ...
  sl: {
    ...
    buttonLabels: ["Ne, hvala", "Oceni zdaj", "Spomni me kasneje"]
  },
  sv: {
    title: "Betygsätt %@",
    message: "Gillar du %@ och kan tänka dig att betygsätta den? Det tar inte mer än en minut. Tack för ditt stöd!",
    buttonLabels: ["Nej tack", "Betygsätt nu!", "Påminn mig senare"]
  },
  th: {
    title: "อัตรา %@",
    ...
    buttonLabels: ["ไม่ขอบคุณ", "ให้คะแนนตอนนี้", "กรุณาเตือนผมมา"]
  },
  tr: {
    title: "Oy %@",
    ...
    buttonLabels: ["Teşekkürler, Hayır", "Şimdi Oyla", "Sonra Hatırlat"]
  },
  uk: {
    title: "Оцінити %@",
    ...
    buttonLabels: ["Ні, дякую", "Оцінити зараз", "Нагадати пізніше"]
  },
  ur: {
    title: "شرح %@",
    ...
    buttonLabels: ["نہیں، شکریہ", "شرح اب یہ", "مجھے بعد میں یاد دلائیں"]
  },
  vi: {
    title: "Đánh giá %@",
    ...
    buttonLabels: ["Không, Cảm ơn", "Đánh Giá Ngay", "Nhắc Tôi Sau"]
  }
};
